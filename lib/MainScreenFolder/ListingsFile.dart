    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Padding(
          ...
          child: ListedTile(details: items[index],Id:vendor_id_list[index]),
        );
      },
    );
  }
...
class rightSide extends StatelessWidget {
  ...
  rightSide({ this.name='NA', this.cuisines='NA',this.stars=4,this.cost=100,this.delivery=false,this.takeaway=false,this.foodistaanCertified=false});
  @override
  Widget build(BuildContext context) {
    var h1 = MediaQuery.of(context).size.height;
    var w1 = MediaQuery.of(context).size.width;
