...
class _AddLocationState extends State<AddLocation> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: currentLocation==null?Text('Fetching Location...'):Text('${currentLocation.latitude}, ${currentLocation.longitude}',),
      ...
      body: currentLocation==null?Center(child: CircularProgressIndicator(),):GoogleMap(
