...
class CartScreenMainPay extends StatefulWidget {
  static String id = 'cart_screen';

  @override
  _CartScreenMainPayState createState() => _CartScreenMainPayState();
}

class _CartScreenMainPayState extends State<CartScreenMainPay> {
  @override
